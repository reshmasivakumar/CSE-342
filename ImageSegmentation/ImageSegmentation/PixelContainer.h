...
#ifndef PixelContainer_h
#define PixelContainer_h
...
class PixelContainer {
	...
	The seed pixel's row and col, the total size of the list and the average
	...
	*/
	...
	friend ostream &operator<<(ostream& out, const PixelContainer& other);

private:
 	NodeData *head;
	// The seed pixel in the input image
	pixel seed;
	int size, redPixelCount, greenPixelCount, bluePixelCount;
	...
	*/
	...
	void copy(const PixelContainer& other);
	...
	and does nothing if the copy method is called on itself.
	*/
	void addPixelNode(const NodeData* other);
...
public:
	...
	*/
	PixelContainer(const PixelContainer& other);
	...
	*/
	...
	PixelContainer& operator= (const PixelContainer& other);
	...
	*/
	...
	bool operator==(const PixelContainer& other)const;
	...
	*/
	...
	void createPixelNode(const pixel& other, int row, int col);
	...
	*/
	...
	void setSeed(const pixel& otherSeed);
	...
	*/
	...
	int getGreenAverageColor() const;
	...
	*/
	...
	void merge(const PixelContainer& other);
	...
	*/
	...
	/*
	getNextData():   This method is used to get the top node's pixel data, average color pixel values and the row and col
	of each pixel.
	The method takes the average pixel variables and row and col as reference input variables and returns the
	pixel of the head node. The head node is popped off the list and head is set to next node


	Precondition: Three valid int reference variables to return back the average color pixel values of red, ble and green pixels and
	int reference variables for row and col
	Postcondition: The head node is popped off the list and the pixel data in the head node is returned . The inut reference variables
	are set to the average of redpixelcount, greenpixelcount and bluepixelcount of all the pixel nodes in the list.


	*/

	void getNextData(pixel& pixel, int& row, int& col);
	 
};
#endif /* PixelContainer_h*/